	...
	<input type="hidden" name="action" value="update">
        ...
        <div class="row align-items-center">
          <div class="col-md-12 col-md-right">
			...
			<div class="form-group">
              <div class="col-sm-12">          
                <input type="text" class="form-control" id="event-main" placeholder="Должность" name="job" value="'.$fetchEvent['job'].'">
              </div>
            </div> 
            <div class="form-group">
              <div class="col-sm-12">          
                <input type="text" class="form-control" id="event-name" placeholder="ФИ" name="name" value="'.$fetchEvent['name'].'">
              </div>
            </div> 
			<div class="form-group">
              <div class="col-sm-12">       
