    ...
    <section class="showcase">
      ...
      <div class="pb-2 mt-4 mb-2 border-bottom">
        ...
        <span id="render-event-data">
         <?php if(!empty($eventClient) && count($eventClient)>0) { ?>
            <?php foreach($eventClient as $key=>$element) { ?>
            <span id="dyn-<?php print $element['id'];?>">
            <div class="card gedf-card" style="margin: 5px;">
    
      <div class="card-body">
          <p class="card-text"><?php print $element['image']; ?></p>
          <p class="card-text"><?php print $element['link']; ?></p>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-sm-12"><h3 style="text-align: center">Добавить нового клиента</h3></div>
            <div class="form-group">
              <div class="col-sm-12">
                <textarea class="form-control" id="event-image" name="image"></textarea>
              </div>
            </div>
            <div class="form-group">
              <div class="col-sm-12">          
                <input type="text" class="form-control" id="event-main" placeholder="Ссылка" name="link">
              </div>
            </div> 
            <div class="form-group">
              <div class="col-sm-12">       
